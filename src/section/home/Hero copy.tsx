...
export const Carousel3D = ({
  ...
  return (
    ...
    <div
      ...
      style={{
        width: "clamp(355px, 25vw, 700px)",
        height: "clamp(480px, 35vw, 620px)"
      }}
    >
      <motion.div
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div
              ...
              className="flex-grow"
            >
              <p className="mb-6 leading-relaxed text-slate-600 font-medium !text-[clamp(13px,1vw,16px)]">
                {data.description}
              </p>
            </div>
      ...
      <div className="relative z-10 w-full min-h-[90vh] flex flex-col justify-center pb-8">
        <div className="container  relative z-10 mx-auto px-4 sm:px-6 max-w-7xl h-full flex flex-col items-center lg:flex-row gap-12 lg:gap-16">
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left order-1">
            <h1 className="font-sora text-slate-900 tracking-tighter mb-4 font-bold !text-[clamp(42px,3.2vw,72px)] !leading-[1.1]">
              Transforming Business <br className="hidden lg:block" /> Through

              {/* FIX 2: Added `&nbsp;` to force the space, and used `!text-[clamp(...)]` to override global CSS so it matches H1 size perfectly */}
              <span
                className="block mt-2 bg-gradient-to-r from-[#2776ea] via-[#2776ea]/90 to-[#76ea27] bg-clip-text text-transparent font-extrabold pb-2 !text-[clamp(36px,3.5vw,68px)] "
