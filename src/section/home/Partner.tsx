...
export default function Integrations() {
  ...
  return (
    <section className="bg-primary py-24 lg:py-32 container-pd font-sora" id="Partners">
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative w-full max-w-[400px] aspect-square bg-white rounded-[2rem] border border-slate-100 shadow-xl transition-all duration-500 hover:shadow-2xl hover:border-blue-100 flex flex-col items-center justify-center gap-6 p-6 overflow-hidden"
      >
        {/* --- IMAGE AREA (Bigger Logo) --- */}
        ...
        {/* --- NAME & LINK AREA (Tighter Spacing) --- */}
