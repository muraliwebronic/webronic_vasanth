...
export const Carousel3D = ({
  ...
  return (
    <div
  className="relative mx-auto perspective-1000 lg:flex-none w-full max-w-[100vw] lg:max-w-none"
  style={{
    width: "min(100%, clamp(355px, 28vw, 560px))",
    height: "min(100%, clamp(480px, 38vw, 760px))"
  }}
>
      <motion.div
      ...
      >
        ...
        {/* Desktop: side arrows */}
        <div className="hidden lg:block absolute top-1/2 -translate-y-1/2 -left-6 z-50">
          <button
            onClick={(e) => {
              e.stopPropagation();
              onPrev();
        ...
        <div className="hidden lg:block absolute top-1/2 -translate-y-1/2 -right-6 z-50">
          <button
            onClick={(e) => {
              e.stopPropagation();
              onNext();
      ...
      <div className="flex lg:hidden items-center justify-center gap-6 mt-5">
        <button
          onClick={(e) => {
            e.stopPropagation();
            onPrev();
      ...
      <div className="relative z-10 w-full min-h-[90vh] flex flex-col justify-center pb-8">
        <div className=" relative z-10 container-pd px-4 sm:px-6  h-full flex flex-col items-center lg:flex-row gap-12 lg:gap-16">
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 mt-5 w-full max-w-md lg:max-w-none justify-center lg:justify-start">
