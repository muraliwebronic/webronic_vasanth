    ...
    <main className="bg-white font-sora pt-24 pb-20">
      <section className="relative overflow-hidden  py-24 ">
        ...
        <div className="relative mx-auto container-pd">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-8 text-sm md:text-base lg:text-lg font-bold text-slate-400">
      ...
      <section className="mx-auto container-pd py-20">
