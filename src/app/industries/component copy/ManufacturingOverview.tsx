...
export default function ManufacturingOverview() {
  ...
  return (
    <section className="bg-white  font-sora overflow-hidden">
      ...
      <div className="py-24 container-pd lg:py-32 relative">
      ...
      <div className="py-24 bg-slate-50/50 border-y container-pd border-slate-100 relative">
      ...
      <div className="py-24 container-pd bg-white relative">
        <div className=" mx-auto px-6 max-w-7xl">
