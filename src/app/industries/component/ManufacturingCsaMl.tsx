              ...
              return (
                <div key={index} className={`p-8 rounded-[2.5rem] transition-all duration-300 ${bgClass}`}>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className={`text-h3 font-bold ${isCenter ? "text-white" : "text-slate-900"}`}>
                        {section.title}
                      </h3>
                      {section.subTitle && (
                ...
                <div className="pl-10 border-l-2 border-slate-200">
                  <ul className="space-y-3">
                    {app.details.map((detail, i) => (
                      <li key={i} className="text-body text-slate-600 leading-relaxed font-medium">
                        {detail}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="space-y-16">
              {mlModels.steps.map((step, index) => (
                <div key={index} className="relative pl-24 md:pl-32">
                  ...
                  <div>
                    <h3 className="text-h3 font-black text-white mb-6">
                      {step.title}
                    </h3>
