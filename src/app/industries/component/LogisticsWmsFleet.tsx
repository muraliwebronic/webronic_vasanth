...
export default function LogisticsWmsFleet() {
  ...
  return (
    <section className="font-sora">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm">
              <div className="flex items-center gap-4 mb-6 pb-4 border-b border-slate-100">
                ...
                <h3 className="text-h3 font-black text-slate-900">{wms.inbound.title}</h3>
              </div>
              <div className="space-y-8">
                {wms.inbound.sections.map((sec, i) => (
                  <div key={i}>
                    <h3 className="text-h3 font-bold mb-3">{sec.title}</h3>
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm">
              <div className="flex items-center gap-4 mb-6 pb-4 border-b border-slate-100">
                ...
                <h3 className="text-h3 font-black text-slate-900">{wms.outbound.title}</h3>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-slate-50 border border-slate-200 p-8 rounded-[2rem] hover:shadow-lg transition-shadow">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-h3 font-bold">{wms.inventory.title}</h3>
              </div>
            ...
            <div className="bg-slate-900 text-white p-8 rounded-[2rem] lg:col-span-2 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="text-h3 font-bold">{wms.automation.title} [Image of warehouse automated storage and retrieval system]</h3>
                </div>
      ...
      <div className="bg-slate-900 py-24 text-white relative overflow-hidden container-pd">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-[2rem]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-h3 font-bold">{lastMile.routePlanning.title}</h3>
              </div>
            ...
            <div className="bg-[#2776ea] p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-h3 font-bold text-white">{lastMile.app.title}</h3>
                </div>
            ...
            <div className="bg-white/5 border border-white/10 p-8 rounded-[2rem]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-h3 font-bold">{lastMile.customer.title}</h3>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-200">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-h3 font-black text-slate-900">{visibility.tracking.title}</h3>
                </div>
            ...
            <div className="bg-slate-900 text-white p-10 rounded-[2.5rem] h-full">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-h3 font-black">{visibility.analytics.title}</h3>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-h3 font-bold text-slate-900">{fleet.tracking.title}</h3>
              </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-h3 font-bold text-slate-900">{fleet.maintenance.title}</h3>
              </div>
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-h3 font-bold text-slate-900">{fleet.compliance.title}</h3>
              </div>
