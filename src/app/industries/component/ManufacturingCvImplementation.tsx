            ...
            {performance.metrics.map((metric, index) => (
              <div key={index} className="bg-white p-8 rounded-[2.5rem] shadow-xl">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-h3 font-black text-slate-900">{metric.category}</h3>
                </div>
        ...
        <div className="mx-auto px-6 max-w-7xl">
          <div className="bg-slate-50 rounded-[3rem] p-10 md:p-20 border border-slate-100">
            <div className="text-center mb-12">
              ...
              <h3 className="text-h3 font-black text-slate-900">{roi.caseStudy.title}</h3>
            </div>

            <div className="grid lg:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div className="bg-white p-8 rounded-3xl border border-slate-200">
                  <h3 className="text-h3 font-bold text-slate-900 mb-4 uppercase tracking-wider">Challenge</h3>
                  <ul className="space-y-2">
                ...
                <div className="bg-white p-8 rounded-3xl border border-slate-200">
                  <h3 className="text-h3 font-bold text-[#2776ea] mb-4 uppercase tracking-wider">Solution</h3>
                  <ul className="space-y-2">
              ...
              <div className="bg-[#2776ea] text-white p-10 rounded-[2.5rem] shadow-xl">
                <h3 className="text-h3 font-black mb-8 text-white border-b border-white/20 pb-4">Results</h3>
