      ...
      <div className="bg-white py-24 lg:py-32 container-pd">
        <div className="mx-auto px-6 max-w-7xl">
          ...
          <div className="text-center mb-12">
            <h3 className="text-h3 font-black text-slate-900 mb-2">{optimization.title}</h3>
            <p className="text-[#2776ea] font-bold uppercase tracking-widest text-sm mb-4">{optimization.subTitle}</p>
            <p className="text-body text-slate-500 max-w-2xl mx-auto">{optimization.description}</p>
          </div>
            ...
            {optimization.techniques.map((tech, index) => (
              <div key={index} className={`bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm ${index === 4 ? "md:col-span-2 lg:col-span-1" : ""}`}>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-h3 font-bold text-slate-900">{tech.title}</h3>
                </div>
      ...
      <div className="bg-[#2776ea] py-24 lg:py-32 text-white container-pd">
        <div className="mx-auto px-6 max-w-7xl">
            ...
            {metrics.kpis.map((kpi, index) => (
              <div key={index} className="bg-white/10 border border-white/20 p-6 rounded-[2rem] hover:bg-white/20 transition-colors">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-h3 font-bold">{kpi.title}</h3>
                </div>
          ...
          <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-xl">
            <h3 className="text-h3 font-black mb-8 text-center text-slate-900">{metrics.results.title}</h3>
            ...
            {collaboration.features.map((feature, index) => (
              <div key={index} className="bg-white p-8 rounded-[2rem] border border-slate-100 hover:border-[#2776ea] transition-colors group">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-h3 font-bold text-slate-900">{feature.title}</h3>
                </div>
                <ul className="space-y-3">
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row items-start gap-12">
                <div className="md:w-1/3">
                  <h3 className="text-h3 font-black mb-2">{collaboration.edi.title}</h3>
                  ...
                  <div className="bg-white/10 p-6 rounded-2xl mb-6 border border-white/10">
                    <h3 className="text-h3 font-bold mb-4">Common Documents</h3>
                ...
                <div className="md:w-2/3 grid sm:grid-cols-2 gap-8">
                  <div className="bg-white p-8 rounded-3xl text-slate-900">
                    <h3 className="text-h3 font-bold mb-6 flex items-center gap-2 text-[#2776ea]"><ArrowRightLeft /> Supplier Benefits</h3>
                    <ul className="space-y-3">
                  ...
                  <div className="bg-white p-8 rounded-3xl text-slate-900">
                    <h3 className="text-h3 font-bold mb-6 flex items-center gap-2 text-[#76ea27]"><ArrowRightLeft /> Manufacturer Benefits</h3>
                    <ul className="space-y-3">
