export const OPEN_POSITIONS_DATA = 
{
  ...
  jobs: [
    ...
    },
    {
      ...
      description: "Design enterprise cloud architectures and lead migration projects for Fortune 100 clients",
      details: {
        whatYouWillDo: [
        ...
        projects: "Cloud transformation for Fortune 100 clients, multi-cloud strategies"
      }
    },
    {
      id: "sec-1",
