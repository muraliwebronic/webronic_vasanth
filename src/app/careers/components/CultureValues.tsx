...
export default function CultureValues() {
  ...
  return (
    <div className="font-sora">
      ...
      <section className="bg-slate-50   container-pd py-24 relative border-b border-slate-100">
      ...
      <section className="py-24 container-pd bg-[#2776ea] relative overflow-hidden text-white">
