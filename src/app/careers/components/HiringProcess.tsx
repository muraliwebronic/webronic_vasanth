        ...
        <section className="bg-white container-pd py-24 font-sora relative overflow-hidden">
            <div className=" mx-auto px-6 max-w-5xl relative z-10">
                ...
                <div className="flex justify-center mb-20">
                    <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#2776ea] border border-[#2776ea]/10 text-white text-caption font-bold uppercase tracking-wider">
                        <Clock size={14} />
                        <span>Total Time: {hiringProcess.totalTimeline}</span>
                    </div>
                </div>

                {/* --- STACKING container-pd --- */}
                    ...
                    {hiringProcess.steps.map((step, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row gap-6 p-6 md:p-10 bg-slate-50/50 rounded-[1.25rem] border border-slate-100/50 h-full">
            ...
            {/* --- COMMITMENTS STRIP --- */}
            <div className="grid grid-cols-2 max-w-5xl mx-auto md:grid-cols-4 gap-6 pt-12 border-t border-slate-100">
