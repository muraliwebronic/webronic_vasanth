                  ...
                  <div className="flex flex-wrap gap-3 mb-12">
                     {hero.ctas.map((cta, i) => (
                        <Link
                           key={i}
                           href={cta.href}
                           className={`inline-flex items-center justify-center px-6 py-3 rounded-xl text-menu font-bold uppercase tracking-wider transition-all active:scale-95 ${cta.primary
