          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {isVirtualTour && (
              <button
                ...
                className={`flex items-center gap-2 pl-5 pr-2 py-1.5 rounded-full border cursor-pointer transition-all ${view === "demo"
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${view === "demo" ? 'bg-[#76ea27] text-white' : 'bg-slate-50 text-slate-400'
                  }`}>
            ...
            <button
              ...
              className={`flex items-center gap-2 pl-5 pr-2 py-1.5 rounded-full border cursor-pointer transition-all ${view === "specs"
            ...
            >
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${view === "specs" ? 'bg-[#2776ea] text-white' : 'bg-slate-50 text-slate-400'
                }`}>
...
export default function ProductSection() {
  return (
    <>
      <section id="products" className="container-pd relative overflow-hidden bg-white py-24 lg:py-32 font-sora">
