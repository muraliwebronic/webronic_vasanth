  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 z-20 flex justify-center pointer-events-none">
        <div className="relative w-[clamp(160px,12vw,220px)] h-[clamp(160px,12vw,220px)] transition-transform duration-500 cubic-bezier(0.25, 0.46, 0.45, 0.94) group-hover:-translate-y-6 group-hover:scale-105 group-hover:rotate-2">
          <Image
            src={image}
            alt={title}
            fill
      ...
      {/* --- 2. THE PEDESTAL --- */}
      <div className="relative h-[80%] w-full bg-white rounded-[2.5rem] border border-slate-100 p-[clamp(24px,2vw,40px)] flex flex-col shadow-sm transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-blue-900/10 group-hover:border-blue-100 overflow-hidden">
        {/* Fake Shadow */}
        ...
        <div className="mt-auto flex items-center justify-between pt-6 border-t border-slate-100 group-hover:border-slate-200/60 transition-colors">
          ...
          <div className="w-[clamp(40px,3vw,56px)] h-[clamp(40px,3vw,56px)] rounded-full bg-slate-50 flex items-center justify-center text-slate-400 transition-all duration-500 group-hover:bg-[#2776ea] group-hover:text-white group-hover:rotate-45 shadow-sm">
