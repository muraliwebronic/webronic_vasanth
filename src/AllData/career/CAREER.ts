...
export const CAREERS_DATA: CareersPageData = {
  hero: {
    ...
    subHeadline:
      "Join a team of 200+ innovators delivering cutting-edge solutions to 100+ clients across 3+ countries. Work on real-world problems using AI, Cloud, IoT, and emerging technologies",
    ctas: [
    ...
    stats: [
      ...
      { value: "13+", label: "Years Innovation", icon: Briefcase },
  ...
  jobs: [
...

    {
      ...
      details: {
        ...
        projects:
          "Cloud transformation for Fortune 100 clients, multi-cloud strategies, large-scale migrations",
      },
    },
