...
export const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Over 13 years of delivering successful projects across 3+ countries, serving clients from startups to Fortune 100 enterprises with consistent 99.9% satisfaction ratings",
    icon: Trophy,
    color: "#2776ea",
  },
  {
